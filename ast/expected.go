...
// 	getTokenType() token.TokenType
// 	getTokenLiteral() string
// 	Test(t *testing.T, node Node) bool
// }
...
// func NewExpectedLetStatement(name string, expression ExpectedExpression) *ExpectedLetStatement {
// 	return &ExpectedLetStatement{name: name, expression: expression}
// }
...
// func (expected *ExpectedLetStatement) Test(t *testing.T, node Node) bool {
...
// func NewExpectedReturnStatment(expression ExpectedExpression) *ExpectedReturnStatment {
// 	return &ExpectedReturnStatment{expression: expression}
// }
...
// func (expected *ExpectedReturnStatment) Test(t *testing.T, node Node) bool {
// 	returnStmt, ok := node.(*ReturnStatement)
// 	if !ok {
// 		t.Errorf("let satetment not found. Got %q token", node.GetTokenType())
// 		return false
// 	}
...
// func (expected *ExpectedIntegerLiteral) Test(t *testing.T, node Node) bool {
...
// func (expected *ExpectedIdentifier) Test(t *testing.T, node Node) bool {
